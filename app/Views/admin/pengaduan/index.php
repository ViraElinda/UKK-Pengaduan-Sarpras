            ...
            <table class="user-admin-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= esc($p['status']); ?></td>
                        <td><?= esc($p['id_user']); ?> - <?= esc($p['nama_pengguna']); ?></td>
                        ...
                        <td>
                            <a href="<?= base_url('admin/pengaduan/edit/'.$p['id_pengaduan']); ?>" class="user-admin-btn-edit">Edit</a>
                            <a href="<?= base_url('admin/pengaduan/delete/'.$p['id_pengaduan']); ?>" onclick="return confirm('Yakin hapus pengaduan ini?')" class="user-admin-btn-delete">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
